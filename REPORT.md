...
<br>
![Sample Ticket with QR Code](data_vis_assets/E_Ticket.png) 
...
![Sample Ticket with QR Code](data_vis_assets/kiosk.png) 
...
![Patient at Site](data_vis_assets/arrived.jpg)

<hr>

### 2. Patient is not at the site(patient at home/office/etc.) - Care Routing System (CRS)

![Patient Not at Site](data_vis_assets/home.jpg)
...
How it would work: 
 ...
 - Formula -> Weighted Mean = (Items * Weight) / Sum of all Weights
  ...
  ![Weighted Mean Formula](data_vis_assets/formulas.png)
...
![K-Means Clustering](data_vis_assets/kmeans_clusters.png)
...
![Voronoi Diagrams](data_vis_assets/VoronoiDiag.png)
